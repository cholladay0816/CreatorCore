<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg p-5 my-4">
                ...
                <div class="pt-5">
                    <div class="flex justify-end">
                        ...
                        @if(isset($commissionPreset))
                            <button type="submit" form="deleteform" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                Delete
                            </button>
                        @endif
            ...
            @if(isset($commissionPreset))
            <form id="deleteform" method="post" action="{{ route('commissionpresets.destroy', $commissionPreset) }}">
                @csrf
                @method('DELETE')
            </form>
            @endif
