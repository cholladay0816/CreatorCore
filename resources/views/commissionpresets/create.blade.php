                            ...
                            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                    <div class="sm:col-span-4"  x-data="{imageName: null, imagePreview: null}">
                                            ...
                                            @if($commissionPreset?->image_path ?? false)
                                                <div class="mt-2" x-show="! imagePreview">
                                                    <img src="{{ $commissionPreset?->image_url() }}" alt="Current Cover Photo" class="rounded w-64 h-48 object-cover">
                                                </div>
                                            @endif

                                                <!-- New Profile Photo Preview -->
                                                <div class="mt-2" x-show="imagePreview">
                                                    <span class="block rounded w-64 h-48"
                                            ...
                                            <label for="image" class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10" x-on:drop.prevent="alert('drop')">
