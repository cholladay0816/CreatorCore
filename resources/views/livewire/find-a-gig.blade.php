<div>
    <div>
        ...
        <div class="mt-1 relative flex items-center">
            <input wire:model="search" type="text" name="search" id="search" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full pr-12 sm:text-sm border-gray-300 rounded-md">
