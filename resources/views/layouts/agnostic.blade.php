...
<head>
    ...
    <meta property='og:title' content='@yield('title') CreatorCore'/>
    <meta property='og:site_name' content='{{ config('app.name', 'CreatorCore') }}'/>
    <meta property='og:type' content='website'/>
    <meta property='og:description' content='@yield('description')'/>
    <meta property='og:image' content='@yield('image')'/>
    <meta name="keywords" content="CreatorCore, creator-core, Commission, Commissioning, Artist, Art, Creator, Digital Art, Holladay Digital, Digital, Holladay">

    <title>@yield('title') CreatorCore</title>
