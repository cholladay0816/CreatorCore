...
<div>
    <nav x-data="{ show = false }" class="bg-gray-800">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-8" src="{{ asset('img/logos/primary-logo.svg') }}" alt="Workflow">
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                            <x-jet-nav-link href="{{ auth()->user() ? route('dashboard') : route('welcome') }}" >Dashboard</x-jet-nav-link>
        ...
        <div class="md:hidden" id="mobile-menu" x-show="show">
