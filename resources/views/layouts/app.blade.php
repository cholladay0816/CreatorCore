                    ...
                    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                        ...
                        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="mt-5 px-2 space-y-1">
                                ...
                                <a href="{{route('notifications.index')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                    <!-- Heroicon name: bell -->
                    ...
                    <div class="flex flex-col h-0 flex-1 bg-gray-800">
                        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="mt-5 flex-1 px-2 bg-gray-800 space-y-1">
                                ...
                                <a href="{{route('notifications.index')}}" class="{{ str_starts_with(\Illuminate\Support\Facades\Route::currentRouteName(), 'notifications') ?'bg-gray-900 text-white':'text-gray-300 hover:bg-gray-700 hover:text-white' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <!-- Heroicon name: bell -->
